  ...
  if (error) {
    return (
      <div className="bg-red-50 border border-red-200 rounded-xl p-4 text-red-700">
        Failed to load loyalty data. Please try again.
      </div>
    );
  }
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-xl p-6">
        <div className="flex justify-between items-start">
          <div>
            <h2 className="text-lg opacity-90 mb-1">Your Points</h2>
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-6">
        ...
        {history.length === 0 && (
          <p className="text-gray-500 text-sm text-center py-4">
            No activity yet. Your points will appear here after your first payment.
          </p>
        )}
      </div>
    </div>
